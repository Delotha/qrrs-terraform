...
resource "aws_db_instance" "database" {
  ...
  instance_class         = var.db_aws.instance_size
  allocated_storage      = var.db_aws.min_size
  max_allocated_storage  = var.db_aws.max_size
  storage_type           = var.db_aws.storage_type
